    ...
    renderSwitch() {
        switch (this.state.intent) {
            case "login":
                return (
                    <form noValidate autoComplete="off" onSubmit={this.handleSubmit}>
                        <TextField label="Email" variant="outlined" required id="email" InputLabelProps={{
                                shrink: true,
                            }}/>
                        <TextField label="Password" variant="outlined" type="password" required id="password" helperText={this.state.helperText2} InputLabelProps={{
                                shrink: true,
                            }}/>
            ...
            case "signUp":
                return (
                    <form noValidate autoComplete="off" onSubmit={this.handleSubmit}>
                        <TextField label="Name" variant="outlined" required id="name" InputLabelProps={{
                                shrink: true,
                            }}/>
                        <TextField label="Email" variant="outlined" required id="email" InputLabelProps={{
                                shrink: true,
                            }}/>
                        <TextField label="Password" variant="outlined" type="password" required id="password" InputLabelProps={{
                                shrink: true,
                            }}/>
                        <TextField
                            id="date"
